...
// memeriksa apakah sesi pengguna memiliki variabel 
if (!isset($_SESSION['nama_admin']) && !isset($_SESSION['pengguna'])) {
    // Jika salah satu dari keduanya tidak ada, maka pengguna diarahkan kembali ke halaman login (login.php) 
    header('location: login.php');
}
// memeriksa apakah pengguna telah mengirimkan permintaan logout
if (isset($_POST['logout'])) {
    //  mengakhiri sesi pengguna dan mengarahkannya kembali ke halaman login
