...
/* Pengecekan ini memeriksa apakah tidak ada variabel sesi 'nama_mahasiswa' 
dan 'pengguna' yang di-set. Jika kondisi tersebut terpenuhi (artinya pengguna belum login),
maka pengguna akan diarahkan ke halaman login.php menggunakan fungsi header(). */
if (!isset($_SESSION['nama_mahasiswa']) && !isset($_SESSION['pengguna'])) {
    header('location:login.php');
}

/* Bagian ini memeriksa apakah ada pengiriman data POST dengan nama 'logout'. 
Jika ya, maka mencoba menyertakan file logout.php dari direktori 'config'. 
File ini mungkin berisi informasi untuk logout. */
