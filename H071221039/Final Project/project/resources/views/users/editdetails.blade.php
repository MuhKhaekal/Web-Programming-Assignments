                ...
                <div class="col-lg-12">
                    <form class="p-4 p-md-5 border-rounded" action="{{ route('update.details') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $userDetails->instagram }}" name="instagram" class="form-control" placeholder="Instagram">
                        </div>
                        ...
                        <div class="col-lg-4 ml-auto mt-3">
                            <div class="">
                                <div class="col-6">
                                    <input type="submit" name="submit" class="btn btn-block btn-primary btn-md w-100" value="Update">
                                </div>
                            </div>
                        </div>
                    </form>
