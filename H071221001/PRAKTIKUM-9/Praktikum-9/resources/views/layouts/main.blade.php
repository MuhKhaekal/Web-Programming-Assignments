...
<body>
    ...
    <nav class="navbar navbar-expand-lg pt-4 pb-4" style="background-color: #000000; color:beige;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search" action="{{ route('jenis') }}" method="GET">
                    ...
                    <button class="btn me-5" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
                            width="30" height="30" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path
